          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-center space-x-8">
                <a href="#home" className="text-red-500 hover:text-red-800">
                  Home
                </a>
                <a href="#about" className="text-red-500 hover:text-red-800">
                  About
                </a>
                <a
                  href="#academics"
                ...
                <a href="#contact" className="text-red-500 hover:text-red-800">
                  Contact
                </a>
          ...
          {isOpen && (
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a
                  href="#home"
                  className="block px-3 py-2 text-red-500 hover:bg-blue-100 rounded"
                >
                  Home
                </a>
                <a
